...
START_TEST(s21_exp_test) {
  ...
  ck_assert_ldouble_eq_tol(exp(-'N'), s21_exp(-'N'), S21_EPS_TEST);
  ck_assert_ldouble_eq_tol(exp(-0.1), s21_exp(-0.1), S21_EPS_TEST);
...
START_TEST(s21_sqrt_test) {
  double base = 0.07;
  ck_assert_ldouble_eq_tol(sqrt(base), s21_sqrt(base), S21_EPS_TEST);
  base = 4.0;
  ck_assert_ldouble_eq_tol(sqrt(base), s21_sqrt(base), S21_EPS_TEST);
  base = 1024.0;
  ck_assert_ldouble_eq_tol(sqrt(base), s21_sqrt(base), S21_EPS_TEST);
  ...
  ck_assert_ldouble_nan(s21_sqrt(base));
  base = INFINITY;
  ck_assert_ldouble_infinite(sqrt(base));
  base = -INFINITY;
